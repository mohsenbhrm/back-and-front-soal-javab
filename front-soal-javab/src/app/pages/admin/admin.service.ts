...
export class AdminService {
  ...
  banUser(id: any): Observable<any> {
    ...
    return this.http.post(`${environment.apiConfig.baseUrl}/api/manageUsers/UserBan`, body);
  }
  unBanUser(id: any): Observable<any> {
    ...
    return this.http.post(`${environment.apiConfig.baseUrl}/api/manageUsers/UserUnBan`, body);
  }
